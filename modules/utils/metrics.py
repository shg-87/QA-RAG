...
class Matching:
    ...
    def __init__(self, model="answer_equivalence_distilbert"):
        """
        Initialize the Metrics_Automated evaluator with a specified transformer model.

        :param model: The name of the transformer model to use.
                      Supports: 
                      - `roberta-large-qa-evaluator`
                      - `answer_equivalence_bert`
                      - `answer_equivalence_distilbert`
                      - `answer_equivalence_roberta`
                      - `answer_equivalence_distilroberta`
                      Refer to the https://github.com/zli12321/qa_metrics documentation.
        """
        self.transformer_matcher = TransformerMatcher("zli12321/" + model)
